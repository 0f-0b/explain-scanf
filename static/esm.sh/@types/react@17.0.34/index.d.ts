...
import * as CSS from '../../csstype@3.0.9/index.d.ts';
import * as PropTypes from '../../@types/prop-types@15.7.4/index.d.ts';
import { Interaction as SchedulerInteraction } from '../../@types/scheduler@0.16.2/tracing.d.ts';
